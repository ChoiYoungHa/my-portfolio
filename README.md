...
| 8  | **Git Webhook Jenkins CI/CD Pipline 구축** | 애플리케이션을 개발단계부터 배포단계까지 자동화하여 좀 더 빠르고 효율적이게 사용자에게 빈번히 배포할 수 있게 하는 것을 목표로합니다. | Jenkins, git-webhook, shell script | &nbsp;&nbsp;🙋(개인) | [GitHub 링크](https://github.com/ChoiYoungHa/FISA3-Jenkins-CICD) | 2024-10-01 |
